                    ...
                    <div className={styles.contentWrapper}>
                        <div className="flex flex-col items-start gap-[var(--spacing-card-gap)] max-w-lg">
                            ...
                            <div className="pt-[var(--spacing-element-gap)]">
                                {/* 🚀 THE FIX: Bulletproof native Next.js link with the exact same styling */}
                                <Link
                                    href="/projects"
                                    className="inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 bg-transparent border border-white/20 text-white hover:bg-white hover:text-black transition-colors duration-300 group relative z-20 pointer-events-auto cursor-pointer"
                                >
                                    <span className="font-medium">Browse My Work</span>
