        ...
        <section className={styles.sectionContainer}>
            <SpringReveal className={styles.differentWrapper} direction="up" scale={true} delay={0.1}>
                ...
                <Card className={cn("glass-panel border-0 flex flex-col md:flex-row items-center px-card-x py-card-y", styles.differentCard)}>
                    ...
                    <div className={cn(styles.avatarWrapper, "group overflow-hidden rounded-(--radius-card-fluid)")}>
                        <Image
                    ...
                    <div className={styles.contentWrapper}>
                        <div className="flex flex-col items-start gap-(--spacing-card-gap) max-w-lg">
                            <h2 className="text-(length:--text-fluid-h2) font-medium text-foreground tracking-tighter leading-[1.1]">
                            ...
                            <div className="pt-(--spacing-element-gap)">
                                ...
                                >
                                    ...
                                    <span className="absolute inset-0 rounded-full bg-linear-to-tr from-transparent via-white/8 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100 pointer-events-none" />
